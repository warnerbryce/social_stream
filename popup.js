...
function update(response){
	if (response !== undefined){
		...
		if ('streamID' in response){
			...
			document.getElementById("dock").rawURL = "https://social.we-keys.fr/dock.html?session="+response.streamID;
			document.getElementById("dock").innerHTML = "<a target='_blank' id='docklink' href='https://social.we-keys.fr/dock.html?session="+response.streamID+"'>https://social.we-keys.fr/dock.html?session="+response.streamID+"</a>";
			document.getElementById("overlay").innerHTML = "<a target='_blank' id='overlaylink' href='https://social.we-keys.fr/index.html?session="+response.streamID+"'>https://social.we-keys.fr/index.html?session="+response.streamID+"</a>";
			document.getElementById("overlay").rawURL = "https://social.we-keys.fr/index.html?session="+response.streamID;
		}
